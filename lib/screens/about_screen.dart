            ...
            children: [
              Container(
                ...
                decoration: const BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(color: Color(0x550077B5), blurRadius: 16, offset: Offset(0, 4)),
                  ],
                ),
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: const [
                        BoxShadow(color: Color(0x550077B5), blurRadius: 8, offset: Offset(0, 2)),
                      ],
                    ),
                    child: const Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 6),
                        Icon(Icons.open_in_new, size: 12, color: Colors.white70),
                      ],
                    ),
                  ),
                ),
            ...
            children: [
              ...
              Container(
                ...
                child: const Text('Final Year M.Tech Project',
                    style: TextStyle(fontSize: 9, color: _cyan, letterSpacing: 0.5)),
              ),
            ],
          ),
        ...
        child: Row(
          children: [
            Container(
              ...
              child: const Icon(Icons.people_alt_outlined, color: _green, size: 24),
            ),
            ...
            const Expanded(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 3),
                  Text('Rate the app · Leave a comment · Read community feedback',
                      style: TextStyle(fontSize: 11, color: _muted, height: 1.4)),
                ],
              ),
            ),
            const SizedBox(width: 12),
            const Icon(Icons.arrow_forward_ios_rounded, size: 16, color: _green),
          ],
        ),
      ),
    );
          ...
          child: Column(
            ...
            children: [
              Text(title, style: const TextStyle(
                  fontSize: 12, color: _text, fontWeight: FontWeight.w600)),
    ...
    return Image.asset(
      ...
      errorBuilder: (_, __, ___) => Image.network(
        ...
        errorBuilder: (_, __, ___) => Center(
          child: Text('KV',
              style: TextStyle(
                  fontSize: size * 0.28, color: Colors.white,
